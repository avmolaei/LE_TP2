...
public class DialogConfiguration extends JDialog implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getActionCommand() == "cancel") {dispose(); valid = false;}
            ...
            try{test = Double.parseDouble(in.getText()); valid = true;JOptionPane.showMessageDialog(new JFrame(), "La nouvelle configuration a bien été prise en compte.\n Elle sera actualisée automatiquement lors de la prochaine conversion.", "Succès", JOptionPane.WARNING_MESSAGE); dispose();}
            catch (Exception Ee) {JOptionPane.showMessageDialog(new JFrame(), "Entrez un nombre !!!", "Alerte", JOptionPane.ERROR_MESSAGE); valid = false;}
        }
